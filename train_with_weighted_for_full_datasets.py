...
output_dir = "./output/Qwen2-VL-7B-Instruct-output_full_datasets_3epoch_300_8bit"
train_dataset_json_path = "latex_ocr_train_full_datasets.json"
val_dataset_json_path = "latex_ocr_val_full_datasets.json"
